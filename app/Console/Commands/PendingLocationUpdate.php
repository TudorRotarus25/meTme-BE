...
class PendingLocationUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'locationUpdate:pending';
    ...
    {                                                                                                                                                                  
        $usersQuery = DB::select('select u.user_id, m.id from meetings m join users_in_meetings u where eta IS NULL or TIMESTAMPDIFF(MINUTE, NOW(), from_time) - eta BETWEEN 5 AND 60');
